...
const MARCAS = {
  es: {
    ...
    // "y" (espanhol "e", francês "et") é ubíquo e discrimina o guia castelhano — sem
    // ele a narração ES curta "não parecia espanhol" na Check 2.
    propria:
      /\b(el|la|los|las|un|una|de|del|que|es|en|por|para|con|se|no|su|lo|le|más|pero|como|este|esta|hay|tiene|puede|quiero|está|son|ya|muy|todo|cuando|si|sí|me|te|nos|y|tu|porque|bien|hoy|cada|sobre|hasta|hacia|sin|ni|entre|desde|gran|cosa|hacer|tener)\b/i
  },
  de: {
    nome: 'alemão',
