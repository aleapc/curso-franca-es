...
<a href="{base}/" class="text-sm text-oceano">← atrás</a>

<header class="mt-2">
  <p class="text-xs font-semibold uppercase tracking-wide text-terracota">
    {nivelLabel}{ep.parte ? ` · Parte ${ep.parte}` : ''}
  </p>
...
{#if ep.aprofundar}
  <details class="card mt-8 p-4">
    <summary class="cursor-pointer font-bold text-oceano">
      📚 Para profundizar — {ep.aprofundar.titulo}
    </summary>
    <p class="mt-1 text-xs text-carvao/50">
      El detalle, si lo quieres. Del todo opcional: el curso funciona sin él.
    </p>
