  ...
  >
    <div class="flex items-center justify-between gap-2">
      <a href="{base}/" class="flex items-baseline gap-1.5">
        <span class="text-lg font-extrabold text-terracota">Dites-moi !</span>
        <span class="hidden text-xs font-medium text-carvao/50 sm:inline">· Francés de supervivencia para Francia</span>
      </a>
        ...
        <div class="relative">
          ...
          {#if menuAberto}
            ...
            >
              ...
              >
                <span class="text-lg">🗣️</span> Traductor de Google
              </a>
              <a
                href="{base}/bolso/"
                onclick={() => (menuAberto = false)}
              ...
              >
                <span class="text-lg">💱</span> Bolsillo del viajero
              </a>
            </div>
          {/if}
        </div>
